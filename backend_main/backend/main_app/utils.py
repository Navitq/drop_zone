...
from .models import Case, CaseItem, Advertisement, BackgroundMainPage
from .redis_models import CaseRedisStandart, ItemRedisStandart, AdvertisementRedis, BackgroundMainPageRedis
