...
def try_load_with_retry():
    ...
    while True:
        try:
            ...
            r.ping()
            print("✅ Redis готов")
            from .utils import load_to_redis, load_global_state_coeff, load_battles_active_main, load_global_coefficient_main, load_raffles, load_advertisement, load_background_main
